...
class ChatIngestor:
    def __init__(self,
        ...
        try:
            ...
            self.temp_dir=self.resolve_dir(self.temp_base)
            self.faiss_dir=self.resolve_dir(self.faiss_base)

            log.info("ChatIngestion initialized",
                session_id=self.session_id,
                temp_dir=str(self.temp_dir),
                faiss_dir=str(self.faiss_dir),
                sessionzed=self.use_session
            )
        
        except Exception as e:
            raise MyException(f"Error in ChatIngestion ; {e}",sys) from e
